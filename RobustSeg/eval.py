...
parser.add_argument('--savepath', default='/home/SHARE2/ZXY/RFNet/RF2Robust/results', type=str)
parser.add_argument('--resume', default='/home/SHARE2/ZXY/RFNet/RF2Robust/results_distill/model_900.pth', type=str)
